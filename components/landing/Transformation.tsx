    ...
    <section className="py-32 px-6 bg-[#030014]">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative">
           {/* BEFORE */}
           <div className="p-10 rounded-3xl bg-white/5 border border-white/5 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
              <h3 className="text-2xl font-bold mb-4">Level 1: The Script Kiddie</h3>
              <ul className="text-left space-y-4 text-muted-foreground mb-8">
           ...
           <div className="p-10 rounded-3xl bg-gradient-to-br from-primary/10 to-secondary/10 border border-primary/50 relative overflow-hidden group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">Level 99: The Arch-Mage</h3>
