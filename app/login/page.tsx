         ...
         <form onSubmit={handleLogin} className="space-y-3">
            <div className="space-y-1">
              ...
              <div className="relative group">
                ...
                <input type="email" className="w-full bg-[#050510] border border-purple-900/30 rounded px-9 py-2 text-xs text-purple-100 placeholder:text-purple-900/40 focus:border-purple-500/50 outline-none transition-all h-9" placeholder="UNIT_ID" />
              </div>
            </div>
